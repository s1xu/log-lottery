export const dialogEn = {
    ...
    dialogDelAllPrize: 'This operation will delete all prize data. Do you want to continue?',
    dialogDelPrize: 'This operation will delete this prize. Do you want to continue?',
    dialogResetDefaultPrize: 'This operation will reset prize data to default. Do you want to continue?',
...
export const dialogZhCn = {
    ...
    dialogDelAllPrize: '该操作会删除所有奖项数据，是否继续？',
    dialogDelPrize: '该操作会删除该奖项，是否继续？',
    dialogResetDefaultPrize: '该操作会将奖项数据重置为默认，是否继续？',
